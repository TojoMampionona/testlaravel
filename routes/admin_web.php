...
use App\Http\Controllers\DroitsAccessControlleur;
...
Route::prefix('users')->group( function(){
	...
	Route::get('edit-profile', [UtilisateurController::class, 'edit'])->name('edit-profile');
	Route::put('update-profile', [UtilisateurController::class, 'update'])->name('update-profile');
	Route::get('user-cards', [UtilisateurController::class, 'showUserCards'])->name('user-cards');
	Route::post('/toggle-lock/{id_utilisateur}', [UtilisateurController::class, 'toggleLock'])->name('toggle-lock');
	Route::get('droits-utilisateur', [DroitsAccessControlleur::class, 'showDroitAccess'])->name('droits-utilisateur');
	Route::post('create-droit-access', [DroitsAccessControlleur::class, 'createDroitAccess'])->name('create-droit');
	Route::put('update-droit-access', [DroitsAccessControlleur::class, 'update'])->name('update-droit');
	Route::delete('/create-droit-access/{id_utilisateur}', [DroitsAccessControlleur::class, 'destroy'])->name('droitacces.destroy');
});
